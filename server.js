...
app.use(session({
    secret: 'somerandomSeries',cookie:{maxAge:1000*60*60*24*30}
}));
...
app.post('/create-user', function(req,res)
{
    ...
    pool.query('INSERT INTO user1 (id,username,password) VALUES($1,$2,$3)',[id,username,dbString], function(err, result){
...
app.post('/login',function(req,res){
   ...
   if (hashedPassword===dbString){
       ...
       //internally  on a server side, it maps the session id to an object
       //{auth:{userId}}
